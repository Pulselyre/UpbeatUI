...
namespace BasicUpbeatUISample.ViewModel
{
    ...
    public class SharedListDataViewModel : BaseViewModel, IDisposable
    {
        ...
        private readonly SynchronizableCollection<string> _strings = new SynchronizableCollection<string>();
        ...
        private void SharedListStringAdded(object sender, EventArgs e) =>
            // Ensure that the collection is changed on the UI thread
            Application.Current.Dispatcher.Invoke(() => _strings.Synchronize(_sharedList.Strings));
