...
{
    /// <summary>
    /// Represents a stack of ViewModels and provides methods and commands for controlling them. Uses an <see cref="IServiceProvider"/> to instantiate ViewModels.
    /// </summary>
    public interface IServiceProvidedUpbeatStack : IUpbeatStack
    {
        /// <summary>
        /// Defines a mapping between the <typeparamref name="TParameters"/> <see cref="Type"/> and the <typeparamref name="TViewModel"/> <see cref="Type"/>. The <see cref="IServiceProvidedUpbeatStack"/>'s <see cref="IServiceProvider"/> will be used to resolve dependencies when creating the <typeparamref name="TViewModel"/>.
        /// </summary>
